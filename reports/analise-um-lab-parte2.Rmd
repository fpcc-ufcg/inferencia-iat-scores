...
Realize a análise sobre o IAT a partir da estimativa das estetísticas via: 

1. bootstraps usando uma bibliotece (exemplo acima)
2. bootstraps implementados por você
